...
| Verb | Base tier | Floor | Flags | Resolvable facts | Modifiable (DECIDE) | Preview keys |
|---|---|---|---|---|---|---|
| services.create_client | LOW | — | — | phone normalized E.164 | — | name, phone |
| services.draft_proposal | LOW | — | — | party_id must exist | amount | title_ar, amount |
| services.send_proposal | HIGH | — | explicit_request | **amount from the stored draft** (never args) | channel | party, title, amount, channel |
| services.create_invoice | HIGH | **HIGH** | explicit_request | amount>0; VAT computed by System | amount | party, amount, vat |
| services.create_payment_link | HIGH | **HIGH** | explicit_request | invoice must exist; PSP-licensed link only | — | invoice, amount, provider |
| services.send_followup | MEDIUM | — | — | party_id, consent active | message | party, message |
